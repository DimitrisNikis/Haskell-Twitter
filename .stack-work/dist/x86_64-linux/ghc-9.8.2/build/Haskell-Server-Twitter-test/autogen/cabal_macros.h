...
/* package network-3.2.4.0 */
#ifndef VERSION_network
#define VERSION_network "3.2.4.0"
...
#define CURRENT_COMPONENT_ID "Haskell-Server-Twitter-0.1.0.0-JotYvxRs4cxEkJXrYmNU3B-Haskell-Server-Twitter-test"
